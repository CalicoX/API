...
- **Enterprise 卡 icon（2026-09-10 Park 参考 Home/列表 3D 方）**：两个圆角方叠——后层实心 `#3b82f6` 右上探出，前层透明毛玻璃（`rgba(255,255,255,0.14)` + `backdrop-filter: blur(10px)`，13 圆角 / 42），白描边符号居中。不要实心渐变、不要紫。
