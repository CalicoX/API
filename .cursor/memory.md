...
- Tracking data 卡（2026-08-18）：浅灰井 `#eef1f5`。中心 17 logo。9 态**全部**白胶囊 + 官方色圆，双环公转要散开（`--r-out: 46cqmin` / `--r-in: 30cqmin`）。涟漪场铺满整井（不关在 420px 里），6 层白圆到约 105%，投影要淡（`0 3px 10px rgba(148,163,184,0.08)`），不要描边。状态圆不要渐变。
