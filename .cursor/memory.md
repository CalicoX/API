...
- Tracking data 卡（2026-08-18）：浅灰井 `#eef1f5`。中心 17 logo。9 态纯色圆公转。涟漪是参考图那种**细、均匀、居中的白同心圆**（SVG `circle`，约 1.25px，7 圈、间距 32），不要 `repeating-radial-gradient` + blur 的水波，不要硬边色带。状态圆官方纯色，不要渐变。
