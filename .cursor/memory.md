...
- **Data Operations 四场停留缩短（2026-09-14 Park「每一个画面停留太长」）**：`dwell` 从 5200/5800/6200/6400 改 3400/3800/4000/4000。只缩短切场间隔，不改进出场曲线、不改场内编排；下限仍盖过各场入场（状态胶囊 ~2.3s、承运商 logo ~3.0s、识别打字+扫 ~2.6s、仪表曲线擦出 ~2.3s）。还长再收。
