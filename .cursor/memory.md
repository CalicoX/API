...
- Land the Integration Together（2026-08-24）：官网原模块，Applications 后、ExploreMore 前。标题粉蓝渐变；五张价卡。Onboard 四步插图是 DOM（浅灰井 `#f7f8fa` + 点阵，白 UI 碎片 8–11px，构图要散开不要铺满）。**不要动画**。产品原文不改。
