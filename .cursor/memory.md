...
- Dashboard 卡（2026-08-21）：对照真实后台三块——① 上左 **按物流主状态** 白卡：donut 在左、9 态图例在右（方色点，官方顺序 Not Found→…→Expired；绿 Delivered 58% / 灰 Not Found 22%），圆心空、不要「9 status」。② 上右 **近90天【查询不到】** 白卡：网格折线，08-14～08-18 贴 0、08-19 抬到 2100 再平台，浅蓝 `#5b9cf5`，小黑 tooltip「08-15 / Qty 0」。③ 井底 **最近消耗** 增长曲线 + 紫面积（半透明→透明）。两卡并排靠井上半，曲线在下。Webhook toast 仍锚右下。不要再做条形 / LED 三拼贴。hover 3.2s：donut 重描、折线重画、曲线呼吸、toast 横滑。reduce-motion 全停。
