            ...
            <div className="ai-lab-intro-inner" id="ai-lab-intro-inner">
              ...
              <div className="ai-lab-intro-copy" id="ai-lab-intro-copy">
                ...
                <h2 id="ai-intro-title">
                  Wide range of applications — thousands of companies run operations on our API
                </h2>
                <p className="lead ai-reveal delay-2">From logistics middleware to e-commerce OMS and risk engines — one tracking feed covers the full shipping lifecycle.</p>
              </div>
              <div className="ai-pills" id="ai-pills">
                <span className="ai-pill"><span className="ai-pill-label">Logistics service</span></span>
                <span className="ai-pill"><span className="ai-pill-label">E-commerce seller</span></span>
                <span className="ai-pill"><span className="ai-pill-label">Finance &amp; payment</span></span>
                <span className="ai-pill"><span className="ai-pill-label">System integrator</span></span>
              </div>
            </div>
          </div>
        </div>
              ...
              <aside className="ai-think" aria-label="AI analyzing">
                <div className="ai-agent-card">
                  <div className="ai-agent-title">
                    <span>API Integration Agent</span>
                  ...
                  <p className="ai-agent-lead">Register numbers, resolve carriers, and push status events into your stack</p>
