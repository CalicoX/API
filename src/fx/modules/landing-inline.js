    ...
    (function () {
      ...
      function setCardLayers(card, px, py) {
        ...
        if (card.classList.contains("explore-card-api")) {
          ...
          setLayer(card.querySelector(".tracking-ui"), ox, oy, 12, 10);
          setLayer(card.querySelector(".tracking-ui-card"), px, py, 10, 8);
          setLayer(card.querySelector(".tracking-ui-float"), ox, oy, 14, 11);
        }
      }
