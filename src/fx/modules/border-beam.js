...
(function (global) {
  ...
  var COLORS = {
    ...
    /* quiet blue-only for rack — fewer spots, muted cyan */
    blue: {
      border: [
        { color: "rgb(56, 140, 210)", pos: "18% -4%", size: "56px 28px" },
        { color: "rgb(40, 110, 190)", pos: "6% 72%", size: "32px 48px" },
        { color: "rgb(70, 150, 220)", pos: "82% 100%", size: "90px 22px" },
        { color: "rgb(50, 120, 200)", pos: "100% 40%", size: "28px 40px" },
      ],
    },
  };
